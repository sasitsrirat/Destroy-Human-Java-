...
public class Optionframe extends JFrame implements ActionListener {
    ...
    protected JPanel epanel, mpanel, cpanel;
    ...
    protected JCheckBox musiccheck, effectcheck, cutScenecheck;
    ...
    private void AddComponents() {
        ...
        effectPanel = new JPanel();
        {
            ...
            effectPanel.setBounds(0, 250, 900, 100);
            ...
            epanel = new JPanel();
            {
                epanel.setBounds(850, 270, 100, 25);
        ...
        cutScenesPanel = new JPanel();
        {
            cutscenesText = new JLabel();
            {
                ...
                cutscenesText.setText("STORY");
                cutscenesText.setBounds(80, 360, 700, 30);
            }
            cutScenesPanel.setBounds(0, 355, 900, 100);
        ...
        JPanel cpanel = new JPanel();
            {
                cpanel.setBounds(850, 355, 100, 25);
                cpanel.setOpaque(false);
                cutScenecheck = new JCheckBox(" hide cutscene ");
